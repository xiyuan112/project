...
<input type="tel" required="required" placeholder="e.g. 011-11223344">
	</div>
			</div>
...
<textarea id="content" name="content" placeholder="Write something on here...">
	...
	<div class="file-upload">
      ...
      <input type="file" id="photo" name="photo" accept="image/jpeg, image/png, image/gif" onchange="previewImage(event)">  <!-- 文件选择和预览 -->
          </div>
...
<br>
		...
		<div style="text-align: center;">
			<button type="submit" class="contact-submit1">Post</button>
			</div>	
